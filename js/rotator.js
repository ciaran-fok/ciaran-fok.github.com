document.addEventListener("DOMContentLoaded", function () {
    const subblocks = document.querySelectorAll("#rotator .image-text-block");
    const blockContainer = document.querySelector("#rotator");
    ...
    function handleHover() { 
        blockContainer.addEventListener("mouseenter", stopRotation); 
        blockContainer.addEventListener("mouseleave", startRotation); 
    }
